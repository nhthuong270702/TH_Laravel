                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" action="dangnhap" class="register-form" id="login-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" placeholder="Email" required @if (!Cookie::get('email'))
                                value="{{ old('email') }}"
                            @else
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" placeholder="Mật Khẩu" @if (!Cookie::get('password'))
                                value="{{ old('password') }}"
                            @else
                            ...
                            <div class="form-group">
                                ...
                                <label for="remember-me" class="label-agree-term"
                                    style="font-family: Arial, sans-serif;"><span><span></span></span>Ghi nhớ đăng
                                    nhập</label>
                                <br> <br>
                        ...
                        <div class="social-login">
                            <span class="social-label" style="font-family: Arial, sans-serif;">Hoặc đăng nhập
                                với</span>
                            <ul class="socials">
